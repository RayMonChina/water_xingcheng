...
public class WUserSearchNewAdapter extends BaseAdapter {
	...
	public WUserSearchNewAdapter(Context context, List<WCBUserEntity> ptEntities,int ChaobiaoTag) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int scTag=ptEntity.getAlreadyUpload();
		int sPrint=ptEntity.getIsPrint();
		String scText="";
		if(scTag==1)
		{
			scText="(未上传)";
